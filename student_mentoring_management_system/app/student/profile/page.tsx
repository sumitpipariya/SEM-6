...
export default function StudentProfilePage() {
  ...
  const [profile, setProfile] = useState({
    ...
    description: "B.Tech Computer Science student focusing on Full Stack Development and AI.",
    ...
    <div className="container-fluid py-4 animate-fade-in">
          ...
          <div className="card-main border-0 shadow-sm overflow-hidden bg-white">
            ...
            <div className="px-4 pb-4">
              <div className="d-flex align-items-end mt-n5 mb-3 gap-3">
                <div className="profile-avatar-lg shadow-lg">
      ...
      <div className="row g-4">
        ...
        <div className="col-lg-4">
          {/* Stats and Security remain same as before... */}
